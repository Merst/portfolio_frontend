...
const SkillChip = ({skill}) => {  
  ...
  return (
    <>
      ...
      <div className={` ${background} center relative inline-block select-none whitespace-nowrap rounded-full py-2 px-3.5 align-baseline font-sans text-xs font-bold leading-none text-white`}>
